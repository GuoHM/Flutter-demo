...
import 'package:helloworld/model/event.dart';

class ListEventPage extends StatefulWidget {
  ListEventPage({Key key, this.title}) : super(key: key);
...
class _ListEventState extends State<ListEventPage> {

  var users = new List<Event>();
